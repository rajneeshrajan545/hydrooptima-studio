...
with col2:
    ...
    fig_cii = go.Figure()
    fig_cii.add_trace(go.Scatter(x=years, y=[5.0, 4.8, 4.6, 4.4, 4.2], mode='lines+markers', name='Unmodified', line=dict(color='crimson')))
    fig_cii.add_trace(go.Scatter(x=years, y=[4.2, 4.0, 3.8, 3.6, 3.4], mode='lines+markers', name='Optimized', line=dict(color='limegreen')))
